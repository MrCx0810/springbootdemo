var centerApi = function(){
	var _this=this;
	this.trim = function(str){
		return str.replace(/(^\s*)|(\s*$)/g,"");
	}
	this.getCenterInfo = function(pageNo,pageSize){
		$.post("centerInfo",{pageNo:pageNo,pageSize:pageSize},function(e){
			if(e.code==100){
				var data = e.data;
				var body1 = template("centertable",data);
