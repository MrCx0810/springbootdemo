var moneyCoinApi = function(){
	var _this=this;
	this.trim = function(str){
		return str.replace(/(^\s*)|(\s*$)/g,"");
	}
	this.getLogInfo = function(pageNo,pageSize){
		$.post("getAllDrawLog",{pageNo:pageNo,pageSize:pageSize},function(e){
			if(e.code==100){
				var data = e.data;
				console.log(e);
				var body1 = template("logtable1",data);
