var showNoticesData = function() {
    var _this = this;
    this.trim = function (str) {
        return str.replace(/(^\s*)|(\s*$)/g, "");
    }
    this.getNoticesList = function (pageNo, pageSize) {
        $.post('getNotice', {pageNo: pageNo, pageSize: pageSize}, function (e) {
            if (e.code == "200") {
                var data = e.data;
                var body1 = template("notices", data);
    ...
    this.getfooter = function (Page) {
        $('.page').Page({
            ...
            callBack : function(page){
                _this.getNoticesList(page, Page.pageSize);
            }
        });
    };
};
