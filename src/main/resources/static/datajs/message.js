...
//     this.getMessageFrom = function(){
//         $.post('getNotice', function(e){
//             console.log(e);
//             if(e.code==200){
//                 $('#content').val(e.data.notice[0].content);
//                 $('#demo1').attr('src', e.data.notice[0].img);
//                 $('.wangEditor-txt').html(e.data.notice[0].detail);
//             }else {
...
//		     selected: '<button style="font-size:20px; margin-top:5px;"><i>I</i></button>'
    ...
    $('#_info').on('click', function () {
        ...
        console.log(data);
        $.post("../admin/SetNotice",data,function(e){
            if(e.code=="200"){
                layer.open({
                    title:'消息提示',
                    icon:6,
